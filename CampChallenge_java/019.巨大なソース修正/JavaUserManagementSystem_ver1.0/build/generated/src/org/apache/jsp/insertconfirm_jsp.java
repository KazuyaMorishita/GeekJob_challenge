...
public final class insertconfirm_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 if(!hs.getAttribute("name").equals("") && !hs.getAttribute("year").equals("") &&
            !hs.getAttribute("month").equals("") && !hs.getAttribute("day").equals("") &&
                !hs.getAttribute("type").equals("") && !hs.getAttribute("comment").equals("")){ 
      out.write("\n");
